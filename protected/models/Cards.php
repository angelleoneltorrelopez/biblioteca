...
class Cards extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('año_edicion', 'length', 'max'=>55),
			array('imagen, descripcion', 'safe'),
	...
	public function search()
	{
		...
		$criteria->compare('pais_autor',$this->pais_autor);
		$criteria->compare('numero_paginas',$this->numero_paginas);
