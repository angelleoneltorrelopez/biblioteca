...
if($model->save())
$this->redirect(array('view','id'=>$model->id_tags));
}
...
$mPDF1->Output('Reporte - Tags '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
