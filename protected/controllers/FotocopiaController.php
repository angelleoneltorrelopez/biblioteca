...
class FotocopiaController extends Controller
{
/**
...
{
$model->attributes=$_POST['Fotocopia'];
if($model->save())
$this->redirect(array('view','id'=>$model->id_fotocopia));
}
...
{
$dataProvider=new CActiveDataProvider('Fotocopia');
...
{
$model=new Fotocopia('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['Fotocopia']))
$model->attributes=$_GET['Fotocopia'];
...
{
$model=Fotocopia::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='fotocopia-form')
{
...
$mPDF1->SetTitle("Reporte - Fotocopia");
...
$mPDF1->Output('Reporte - Fotocopia '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
