...
if($model->save())
$this->redirect(array('view','id'=>$model->id_categorias));
}
...
$mPDF1->Output('Reporte - Categorias '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
