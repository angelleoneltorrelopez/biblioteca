...
$mPDF1->SetTitle("Reporte - Bitacora");
...
$mPDF1->Output('Reporte - Bitacora '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
