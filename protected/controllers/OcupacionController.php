...
'actions'=>array('view','create','admin','update','delete'),
...
if($model->save())
$this->redirect(array('view','id'=>$model->id_ocupacion));
}
...
$mPDF1->SetTitle("Reporte - Ocupacion");
...
$mPDF1->Output('Reporte - Ocupacion '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
